# Publication Spacing and Homepage Label Design
...
- Assert the exact new spacing and label placement.
- Run the existing site test suite and `git diff --check` before pushing `master`.
